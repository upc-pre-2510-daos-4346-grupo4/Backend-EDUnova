package pe.edu.upc.center.edunova.iam.application.internal.queryservices;

import pe.edu.upc.center.edunova.iam.domain.model.aggregates.User;
import pe.edu.upc.center.edunova.iam.domain.model.queries.GetAllUsersQuery;
import pe.edu.upc.center.edunova.iam.domain.model.queries.GetUserByIdQuery;
import pe.edu.upc.center.edunova.iam.domain.model.queries.GetUserByUsernameQuery;
import pe.edu.upc.center.edunova.iam.domain.services.UserQueryService;
import pe.edu.upc.center.edunova.iam.infrastructure.persistence.jpa.repositories.UserRepository;
